	   ...
	   $(jogos).each(function(ii,jogo){			   
			 ...
			 if(  (jogo.home==home) && (jogo.away==away) ){
				   ...
				   jogo_selecionado=bot.jogoLive(home,away);
					...
					else if (( ( jogo.ind<=-1.50 ) &&  ( jogo.ind2<=-0.75) && 	( jogo_selecionado.AH_Away>=0)  &&  ( jogo.gA==0.0) &&  ( (primeiroTempo() && (jogo_selecionado.tempo>=38)) ||  (segundoTempo() && (jogo_selecionado.tempo>=88))    ) ))  { bot.lista_de_apostas.push(home+' v '+away);  bot.apostar(jogo_selecionado.selAway); }  
